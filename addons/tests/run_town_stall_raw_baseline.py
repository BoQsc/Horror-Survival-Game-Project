...
RESET_ENV_KEYS = [
    "TOWN_STALL_GODOT_FULLSCREEN",
    "TOWN_STALL_GODOT_WINDOWED",
    "TOWN_STALL_GODOT_RESOLUTION",
    "TOWN_STALL_MAX_FPS",
...
def _load_snapshot_summary(path: Optional[Path]) -> dict[str, Any]:
    ...
    terrain_batch = {
        ...
        for key in [
            ...
            "distant_world_map_lod_enabled",
            "distant_world_map_lod_distance",
            "distant_world_map_lod_overlap",
            "distant_world_map_lod_sample_step",
            "distant_world_map_lod_budget_per_frame",
            "distant_world_map_lod_defer_until_initial_viewer_move",
            "distant_world_map_lod_deferred",
            "world_map_lod_chunk_count",
            "world_map_lod_node_count",
            "world_map_lod_merged",
            "world_map_lod_pending_candidate_count",
            "world_map_lod_replace_active_chunks_enabled",
            "world_map_lod_full_res_visual_radius_chunks",
            "world_map_lod_replaced_terrain_chunk_count",
            "world_map_lod_mesh_count",
            "world_map_lod_primitive_count",
            "last_world_map_lod_loads",
            "last_world_map_lod_unloads",
            "last_world_map_lod_update_ms",
            "last_world_map_lod_merge_ms",
