...
def main() -> int:
    ...
    env["TOWN_STALL_ENABLE_TRANSVOXEL_PREVIEW"] = os.environ.get("TOWN_STALL_ENABLE_TRANSVOXEL_PREVIEW", "0")
    env["TOWN_STALL_HOLD_SECONDS"] = os.environ.get("TOWN_STALL_HOLD_SECONDS", "0")
