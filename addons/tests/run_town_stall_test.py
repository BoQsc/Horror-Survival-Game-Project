...
def main() -> int:
    ...
    env["TOWN_STALL_DISABLE_BUILDING_BAKE"] = os.environ.get("TOWN_STALL_DISABLE_BUILDING_BAKE", "0")
    env["TOWN_STALL_PRELOAD_BUILDINGS"] = os.environ.get("TOWN_STALL_PRELOAD_BUILDINGS", "0")
