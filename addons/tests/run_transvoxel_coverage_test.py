...
MAIN_SCENE = "res://addons/tests/transvoxel_coverage_test.tscn"
TIMEOUT = 300
LOG_FILE = Path(PROJECT_PATH) / ".agent" / "transvoxel-coverage-test.log"
...
def main() -> int:
    print("Running Transvoxel Coverage Test...")
