...
MAIN_SCENE = "res://addons/tests/transvoxel_excavation_test.tscn"
TIMEOUT = 300
LOG_FILE = Path(PROJECT_PATH) / ".agent" / "transvoxel-excavation-test.log"
...
def main() -> int:
    print("Running Transvoxel Excavation Test...")
