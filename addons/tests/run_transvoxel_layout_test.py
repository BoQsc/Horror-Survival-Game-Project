...
MAIN_SCENE = "res://addons/tests/transvoxel_layout_test.tscn"
TIMEOUT = 300
LOG_FILE = Path(PROJECT_PATH) / ".agent" / "transvoxel-layout-test.log"
...
def main() -> int:
    print("Running Transvoxel Layout Test...")
