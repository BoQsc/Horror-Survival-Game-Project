...
MAIN_SCENE = "res://addons/tests/transvoxel_normal_test.tscn"
TIMEOUT = 300
LOG_FILE = Path(PROJECT_PATH) / ".agent" / "transvoxel-normal-test.log"
...
def main() -> int:
    print("Running Transvoxel Normal Test...")
