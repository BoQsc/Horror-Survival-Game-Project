...
MAIN_SCENE = "res://addons/tests/transvoxel_seam_gap_test.tscn"
TIMEOUT = 300
LOG_FILE = Path(PROJECT_PATH) / ".agent" / "transvoxel-seam-gap-test.log"
...
def main() -> int:
    print("Running Transvoxel Seam Gap Test...")
