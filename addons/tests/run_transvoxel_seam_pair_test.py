...
MAIN_SCENE = "res://addons/tests/transvoxel_seam_pair_test.tscn"
TIMEOUT = 300
LOG_FILE = Path(PROJECT_PATH) / ".agent" / "transvoxel-seam-pair-test.log"
...
def main() -> int:
    print("Running Transvoxel Seam Pair Test...")
