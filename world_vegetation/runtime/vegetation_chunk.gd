...
var visible_individual_bush_record_count: int = 0
var visible_chunked_bush_record_count: int = 0
var visible_rock_record_count: int = 0
var visible_individual_rock_record_count: int = 0
var visible_chunked_rock_record_count: int = 0
...
var individual_tree_estimated_primitive_count: int = 0
var chunked_tree_estimated_primitive_count: int = 0
var bush_estimated_primitive_count: int = 0
var individual_bush_estimated_primitive_count: int = 0
var chunked_bush_estimated_primitive_count: int = 0
var rock_estimated_primitive_count: int = 0
var individual_rock_estimated_primitive_count: int = 0
var chunked_rock_estimated_primitive_count: int = 0
...
func reset() -> void:
	...
	visible_individual_bush_record_count = 0
	visible_chunked_bush_record_count = 0
	visible_rock_record_count = 0
	visible_individual_rock_record_count = 0
	visible_chunked_rock_record_count = 0
	...
	individual_tree_estimated_primitive_count = 0
	chunked_tree_estimated_primitive_count = 0
	bush_estimated_primitive_count = 0
	individual_bush_estimated_primitive_count = 0
	chunked_bush_estimated_primitive_count = 0
	rock_estimated_primitive_count = 0
	individual_rock_estimated_primitive_count = 0
	chunked_rock_estimated_primitive_count = 0
